...
<Container>
      <Row>
        <Col xs={12} md={6}>
          ...
          <p>تلفن تماس با بشتیبانی: 09151080973</p>
          <p>آدرس بستی: مشهد صندوق بستی ۱۱۲۲۳۳۴۴۵۵</p>
        </Col>
        <Col xs={12} md={6}>
      ...
      <Row>
        <Col md={12}>
          <div>
            فروشگاه اینترنتی شهزاد با افتخار در ارائه خدمات مختلف فروشگاهی و
          ...
          <h5 style={{textAlign:"center"}}>
              استفاده از مطالب این فروشگاه صرفا با ارائه منبع مجاز می باشد و کلیه حقوق متعلق به شرکت شهزاد است.
          </h5>
        </Col>
      </Row>
      </Container>
