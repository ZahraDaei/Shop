...
function* fetchCategoryTree() {
    try {
        ...
        yield put({ type: "CATEGORY_TREE_FETCH_SUCCEEDED" });
        yield put({ type: "category/getCategoriesTree", payload: category });
    } catch (e) {
...
function* fetchCategory() {
    try {
        ...
        yield put({ type: "category/getCategories", payload: category.categoryDto });
    } catch (e) {
