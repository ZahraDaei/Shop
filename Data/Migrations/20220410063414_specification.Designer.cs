...
namespace Store.Data.Migrations
{
    ...
    [Migration("20220410063414_specification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Models.DeliveryDate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Store.Models.ProductSpecification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Store.Models.Specification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Store.Models.CartProduct", b =>
                {
                    ...
                    b.HasOne("Store.Models.ShoppingCart", null)
                        .WithMany("CartProducts")
            ...
            modelBuilder.Entity("Store.Models.ProductSpecification", b =>
                {
                    ...
                    b.HasOne("Store.Models.Specification", "Specification")
                        .WithMany("ProductSpecifications")
            ...
            modelBuilder.Entity("Store.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("Store.Models.DeliveryDate", null)
                        .WithMany("ShoppingCarts")
